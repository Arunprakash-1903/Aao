...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = () => {
    signIn("google",{callbackUrl: "/v2024"} )
      ...
      <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
        ...
        <div className="mt-4">
          ...
          {/* <button
            ...
            className="w-full bg-gray-200 text-gray-700 py-2 rounded-lg font-medium hover:bg-gray-300 focus:ring focus:ring-blue-300 transition duration-300 mb-4"
          >
            Create Account
          </button> */}
          {/* <button onClick={()=>{signIn("google",{redirectTo:"/v2024"})
