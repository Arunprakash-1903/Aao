...
export default function ProfileUploadForm() {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen flex justify-center">
      <div className="max-w-6xl w-full grid grid-cols-4 gap-8">
        {/* Left Section */}
                ...
                <div className="flex-col justify-between items-center w-full">
                  ...
                  {userData && (
                    <div className="flex items-center gap-4">
                      <img
                        src={userData.profilePicture || "/default.jpg"}
                        alt="Profile"
                        className="h-20 w-20 rounded-full border border-gray-300"
                      />
                      <div>
                        <p className="text-lg font-semibold">{userData.name}</p>
                        <p className="text-gray-600">{userData.contactNumber || "Contact Number"}</p>
                        <p className="text-gray-600">{userData.profileDesignation || "Designation"} </p>
                      </div>
                    </div>
                  )}
{/* 
